  ...
  return (
    <div className="h-full bg-inherit">
      <div className="bg-black shadow-md ">
        <div className="flex flex-col mt-32 p-5 mx-auto text-white md:mx-auto max-w-lg">
          {/* Logo */}
          <Link href="/">
          ...
          <div className="mt-3">
            <form onSubmit={handleSignUp}>
              ...
              <div className="flex justify-between">
                <input
                  className="leading-none w-40 md:w-auto text-gray-50 p-3 focus:outline-none focus:border-blue-700 my-1 border-0 bg-gray-800 rounded"
                  type="firstName"
                  id="firstName"
